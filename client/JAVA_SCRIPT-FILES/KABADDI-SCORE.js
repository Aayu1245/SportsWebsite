document.addEventListener('DOMContentLoaded', function () {
    ...
    const team1 = {
        name: "Team A",
        players: [
            { number: 1, name: "Raider 1", position: "Raider", stats: [] },
            { number: 2, name: "Raider 2", position: "Raider", stats: [] },
            { number: 3, name: "Defender 1", position: "Defender", stats: [] },
            { number: 4, name: "Defender 2", position: "Defender", stats: [] },
            { number: 5, name: "All-Rounder 1", position: "All-Rounder", stats: [] },
            { number: 6, name: "All-Rounder 2", position: "All-Rounder", stats: [] },
            { number: 7, name: "Substitute 1", position: "Substitute", stats: [] }
        ],
        score: 0,
        timeouts: 5
    };
